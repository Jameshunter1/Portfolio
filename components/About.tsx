  ...
  return (
    <motion.div
      ...
      <motion.img
        ...
        viewport={{ once: true }}
        src={urlFor(pageInfo.profilePic).url()} className='-mb-20 mt-20 md:mb-0 flex-shrink-0 h-56 w-[200px] object-cover rounded-full md:rounded-none md:w-[400px] md:h-[400px]'
      />
