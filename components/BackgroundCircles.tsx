 ...
 function BackgroundCircles({}: Props) {
  return (
      <motion.div
          ...
          <div className="rounded-full border border-[#5572af] opacity-20 h-[650px] w-[650px] absolute mt-52 animate-pulse"/>
          <div className="rounded-full border border-[#3333] h-[800px] w-[800px] absolute mt-52" />  
