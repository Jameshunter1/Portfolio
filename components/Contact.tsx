  ...
  return (
    <div className="h-screen flex relative flex-col text-center md:flex-flow max-w-7xl px-10 justify-evenly mx-auto items-center">
      ...
      <div className="flex flex-col relative items-center">
        ...
        <div className="flex flex-col  sm:items-center space-y-2 mb-20 sm:mb-0">
        ...
        <form
          ...
          className="flex flex-col  mt-5 mx-auto w-[250px] md:w-[500px] justify-between caret-white"
        >
          <input
            {...register("name")}
            placeholder=" Name"
